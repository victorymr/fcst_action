...
# %% auto 0
__all__ = ['IN_COLAB', 'project_id', 'start_date', 'end_date', 'data', 'get_campaign_details', 'fetch_forecast_data_all',
           'fetch_forecast_data_lead', 'fetch_forecast_data_lead2', 'evaluate_campaign_trigger', 'assign_ad_type',
           'print_campaign_story', 'get_campaign_hist', 'campaign_heatmap', 'create_map', 'map_campaigns_by_day',
...
def get_campaign_summary(city_res_df):
  ...
  summary_stats = {
    'Duration per ad per city (in seconds)': duration_per_ad_per_city,
    'Percentage of total time per ad per city:': percentage_per_ad_per_city
  }
