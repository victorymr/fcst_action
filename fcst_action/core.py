...
# %% auto 0
__all__ = ['credentials_path', 'project_id', 'start_date', 'end_date', 'data', 'get_campaign_details', 'fetch_forecast_data_all',
           'fetch_forecast_data_lead', 'fetch_forecast_data_lead2', 'fetch_precip_forecast_data_lead2',
           'fetch_forecast_data_lead3', 'evaluate_campaign_trigger', 'assign_ad_type', 'print_campaign_story',
           'get_campaign_hist', 'campaign_heatmap', 'create_map', 'map_campaigns_by_day', 'get_campaign_summary']
